...
TEST_CASE("nxx::deriv - Numerical Derivatives Test", "[derivatives]")
{
    ...
    SECTION("nxx::deriv::forward") { testDerivativeMethod(Order1ForwardRichardson {}, functions, first_derivatives, evals, 1E-6); }

    SECTION("nxx::deriv::backward") { testDerivativeMethod(Order1BackwardRichardson {}, functions, first_derivatives, evals, 1E-6); }
    ...
    SECTION("Order1ForwardHighOrder") { testDerivativeMethod(Order1ForwardRichardson {}, functions, first_derivatives, evals, 1E-6); }
    ...
    SECTION("Order1BackwardHighOrder") { testDerivativeMethod(Order1BackwardRichardson {}, functions, first_derivatives, evals, 1E-6); }
